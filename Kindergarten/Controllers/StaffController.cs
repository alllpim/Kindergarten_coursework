...
namespace Kindergarten.Controllers
{
    ...
    public class StaffController : Controller
    {
        ...
        private IQueryable<Staff> GetSortedStaff(SortState sortState, string info, string reward)
        {
            IQueryable<Staff> staff = _context.Staff.Include(x => x.Position).Include(x => x.Groups).AsQueryable();
